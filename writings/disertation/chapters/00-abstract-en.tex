...
%% Pedoman ITB §II.2: 4 paragraphs, no references, keywords ≤ 7 phrases
%% Phase H — rewritten to reflect two-track narrative per outline §Abstract
...
RMSE $0.226 \pm 0.030$ on PHM2012, N-BEATS-xLSTM achieves
$0.259 \pm 0.003$ on XJTU-SY, and Mamba-xLSTM achieves
...
$r_{\rm max} = 0.507$), while BPFO dominates on XJTU-SY (2.2\%,
$p < 0.001$, $r_{\rm max} = 0.501$).
