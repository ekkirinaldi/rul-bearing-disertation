...
Bab ini menyajikan \textcolor{blue}{komponen diagnostik} dari penelitian ini secara \emph{end-to-end}: mulai dari perancangan
...
\begin{enumerate}
  ...
  \item \textbf{Varian B (Kernel Sempit):} Ukuran kernel pertama diperkecil
        ...
        \textcolor{blue}{Jumlah parameter meningkat sebesar \
...
\textcolor{blue}{\citenameitb{Lundberg2017SHAP}}, dengan kompleksitas waktu $O(TLD^2)$ di mana $T$
