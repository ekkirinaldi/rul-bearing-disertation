...
\emph{inner race} \emph{Bearing}~1 pada \emph{Run}~2, sementara munculnya BSF
(0{,}49\%) mencerminkan kegagalan \emph{rolling element} \emph{Bearing}~4 pada
\emph{Run}~1.
...
mekanistik di domain prognostik \emph{bearing} dianggap \emph{robust} secara
ilmiah.
