...
Bab ini menyajikan \textcolor{blue}{komponen prognostik} dari penelitian ini secara \emph{end-to-end}, 
...
Variasi pada \textcolor{blue}{bias induktif} ketiga arsitektur ini sengaja dipilih agar uji
...
untuk memprediksi RUL dengan \textcolor{blue}{menempatkan sebuah
...
pada NVIDIA~A40 \textcolor{blue}{dengan tetap mempertahankan akurasi numerik setara komputasi 
...
Fakta bahwa BPFO dan BPFI muncul sebagai satu-satunya BPFx dengan \emph{hit-rate}
...
\textcolor{blue}{Pelaporan konsistensi parsial ini secara terbuka justru memperkuat kredibilitas ilmiah
...
Selanjutnya, Bab~VI akan mensintesiskan hasil \textcolor{blue}{komponen diagnostik} (Bab~IV) dan \textcolor{blue}{komponen prognostik} (Bab ini)
