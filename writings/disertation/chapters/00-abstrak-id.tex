...
Bantalan gelinding merupakan komponen yang paling rentan terhadap
...
untuk prediksi RUL bantalan gelinding, yang mengintegrasikan
...
bantalan: Mamba menangani dependensi temporal jangka panjang pada fase
...
frekuensi karakteristik fisik bantalan --- \emph{Ball Pass Frequency
...
yaitu PHM2012 (FEMTO-PRONOSTIA) yang memuat 17 bantalan NSK~6804 dalam
tiga kondisi operasi, dan XJTU-SY yang memuat 10 bantalan LDK~UER204
(kondisi 1 dan 2).
...
berkorespondensi dengan teori klasik diagnosis getaran bantalan.
...
bantalan; (2)~prosedur pemetaan SAE ke frekuensi karakteristik fisik
