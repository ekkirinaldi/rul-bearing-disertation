...
\textcolor{blue}{diorganisasi dalam delapan kelompok tematik:
(1)~perawatan prediktif dalam konteks Industri 4.0,
(2)~fisika getaran \emph{rolling element bearing},
(3)~diagnostik \emph{rolling element bearing} berbasis \emph{deep learning},
(4)~\emph{explainable AI} (XAI) pada tingkat atribusi input,
(5)~prognostik \emph{rolling element bearing} dan estimasi sisa umur pakai,
(6)~interpretabilitas mekanistik berbasis \emph{sparse autoencoder} (SAE),
(7)~tinjauan lintas domain XAI pada sinyal satu dimensi, dan
(8)~peta kesenjangan literatur yang memposisikan penelitian ini relatif
terhadap karya terkait.}
...
% - §II.6 (fisika getaran) DIPINDAHKAN menjadi §II.2 agar frekuensi
...
% -----------------------------------------------------------------
\textcolor{blue}{\section{Fisika Getaran \emph{Rolling Element Bearing}}
\label{sec:bab2_fisika_getaran}}

\textcolor{blue}{Pemahaman terhadap fisika getaran \emph{rolling element bearing} memberikan \emph{ground
truth} yang diperlukan untuk (i)~memvalidasi apakah pola atribusi SHAP DeepExplainer
pada Bab~IV bersesuaian dengan impuls transien fisik, dan (ii)~memvalidasi pemetaan
...
\textcolor{blue}{Sebagai perbandingan dengan literatur eksternal,
Tabel~\ref{tab:bab2_klasifikasi_survey} menyertakan representasi karya
terpilih dari tiga kelompok untuk konteks.}
Tabel~\ref{tab:bab2_klasifikasi_survey} merangkum kinerja dan kapabilitas
interpretabilitas dari representasi tiap kelompok. \textcolor{blue}{Angka kunci
dari karya penelitian ini} dilaporkan dari
...
\begin{table}[ht]
  ...
  \begin{tabularx}{\textwidth}{@{}l l l c l c@{}}
    ...
    WDCNN (var C, tanpa BN) & Jaringan dalam & CWRU & \textcolor{blue}{96,13} & \emph{DeepExplainer} & \checkmark \\
    \textcolor{blue}{CNN-1D (Zhang dkk., 2017)$^*$} & \textcolor{blue}{Jaringan dalam} & \textcolor{blue}{CWRU} & \textcolor{blue}{99,60} & \textcolor{blue}{—} & \textcolor{blue}{—} \\
    \bottomrule
  \end{tabularx}
...
\textcolor{blue}{Sebelum model \emph{deep learning} dapat dilatih untuk estimasi RUL, sinyal getaran
...
sebagai amplitudo RMS getaran yang melampaui ambang 20~g; label RUL kemudian
...
hingga §\ref{sec:bab2_xai_lintas_domain}, tiga kesenjangan spesifik dan dapat
