...
konteks Industri 4.0, (2)~diagnostik \emph{rolling element bearing} berbasis \emph{deep
learning}, (3)~\emph{explainable AI} (XAI) pada tingkat atribusi input,
(4)~prognostik \emph{rolling element bearing} dan estimasi sisa umur pakai, (5)~interpretabilitas
mekanistik berbasis \emph{sparse autoencoder} (SAE), (6)~fisika getaran
\emph{rolling element bearing}, dan (7)~peta kesenjangan literatur yang memposisikan
...
paling luas digunakan dalam riset diagnostik \emph{rolling element bearing}
...
\subsection{Klasifikasi \emph{Bearing} Multi-Model: Kernel, Pohon, dan Dalam}
...
\begin{table}[ht]
  ...
  \caption{Ringkasan kinerja dan kapabilitas interpretabilitas tiga kelompok
           algoritma klasifikasi \emph{bearing} pada dataset CWRU.}
...
diagnostik \emph{bearing} (\emph{novelti N2}).
...
% -----------------------------------------------------------------
\section{Fisika Getaran \emph{Rolling Element Bearing}}
\label{sec:bab2_fisika_getaran}
% -----------------------------------------------------------------

Pemahaman terhadap fisika getaran \emph{rolling element bearing} memberikan \emph{ground
...
Untuk \emph{bearing} SKF~6205-2RS~JEM yang digunakan dalam dataset CWRU ($n = 9$,
...
Sinyal getaran \emph{bearing} yang rusak $x(t)$ merupakan superposisi komponen
