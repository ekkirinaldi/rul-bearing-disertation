...
pada Subbab~\ref{sec:bab2_gap_literatur} menjadi \textcolor{blue}{justifikasi langsung bagi
ketiga rumusan masalah} yang dirumuskan pada \textcolor{blue}{Subbab~\ref{sec:bab1_rumusan}}.
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.88\textwidth]{figures/bab2/fig_lstm_cell.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.80\textwidth]{figures/bab2/fig_mamba_ssm_block.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.78\textwidth]{figures/bab2/fig_slstm_block.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.78\textwidth]{figures/bab2/fig_mlstm_block.png}
...
Gambar~\ref{fig:bab2_sae_architecture} mengilustrasikan arsitektur
Top-$k$ SAE yang digunakan dalam penelitian ini.

\begin{figure}[ht]
  \centering
  \includegraphics[width=0.86\textwidth]{figures/bab2/fig_sae_architecture.png}
  \caption{Arsitektur Top-$k$ \emph{Sparse Autoencoder} (SAE)
           \citetitb{Cunningham2023TopkSAE}: \emph{hidden state} $\mathbf{h} \in \mathbb{R}^d$
           dari \emph{backbone} RUL dikodekan ke \emph{dictionary} berlapis
           ($d_{\rm lat} = 8d$), kemudian hanya $k$ fitur teraktif ($k = 51$,
           $\approx 5\%$) yang dipertahankan sebagai kode \emph{sparse} $\mathbf{z}$.
           \emph{Loss} rekonstruksi MSE mendorong SAE membangun representasi yang
           dapat diinterpretasi secara monosemantik.}
...
Gambar~\ref{fig:bab2_sae_pipeline} merangkum \emph{pipeline} interpretabilitas
mekanistik yang diusulkan secara keseluruhan.

\begin{figure}[ht]
  \centering
  \includegraphics[width=0.94\textwidth]{figures/bab2/fig_sae_pipeline.png}
  \caption{\emph{Pipeline} interpretabilitas mekanistik SAE–BPFx
           \citetitb{TotoSuharto2025Journal2RUL}: sinyal vibrasi mentah
           diproses oleh tiga \emph{backbone} RUL beku untuk menghasilkan
           \emph{pool} \emph{hidden state}, kemudian Top-$k$ SAE
           mengekstrak kode \emph{sparse}, dan korelasi Pearson terhadap
           amplitudo Hilbert \emph{envelope} pada empat frekuensi karakteristik
           (BPFO, BPFI, BSF, FTF) menghasilkan \emph{hit-rate} per BPFx.
           Validitas dikonfirmasi dengan \emph{bootstrap} 95\% CI,
           \emph{permutation test}, dan dua \emph{negative control}.}
  \label{fig:bab2_sae_pipeline}
\end{figure}
...
\textcolor{blue}{Berdasarkan tinjauan pada Subbab~\ref{sec:bab2_pdm_industri}
...
pada Subbab~\ref{sec:bab1_rumusan}: \textcolor{blue}{Kesenjangan~1 dan~2
