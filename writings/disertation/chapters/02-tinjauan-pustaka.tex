...
\subsection{Klasifikasi Bantalan Multi-Model: Kernel, Pohon, dan Dalam}
...
melainkan dijalankan sebagai \emph{benchmark} lintas kelompok untuk memahami
...
\textbf{Model berbasis pohon keputusan.} \emph{Decision Tree} (DT),
...
\textbf{Model berbasis jaringan dalam.} WDCNN beroperasi langsung pada
...
interpretabilitas dari representasi tiap kelompok. Angka kunci dilaporkan dari
...
\begin{table}[ht]
  \centering
  \caption{Ringkasan kinerja dan kapabilitas interpretabilitas tiga kelompok
  ...
  \begin{tabularx}{\textwidth}{@{}l l l c l c@{}}
    ...
    WDCNN (var A) & Jaringan dalam  & CWRU & 99,87 & \emph{DeepExplainer}  & \checkmark \\
    WDCNN (var C, tanpa BN) & Jaringan dalam & CWRU & 96,27 & \emph{DeepExplainer} & \checkmark \\
    \bottomrule
  \end{tabularx}
...
model kernel dan pohon memberikan akurasi yang layak untuk \emph{edge
...
yang ketat. Untuk domain diagnostik bantalan, metode berbasis perturbasi, khususnya SHAP,
...
Ketiganya memiliki karakteristik berbeda, mencakup jenis bantalan, kondisi
...
prognostik bantalan (\emph{novelti N3: SAEBearing}), (ii)~memetakan
