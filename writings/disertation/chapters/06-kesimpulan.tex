...
\emph{bearing}, (2) membangun skema interpretabilitas berbasis SAE dengan pemetaan
ke frekuensi karakteristik fisik \emph{bearing}, dan (3) menganalisis konsistensi
...
saling memperkuat pada sinyal getaran \emph{bearing} yang bersifat non-stasioner.
...
\emph{envelope} Hilbert pada pita frekuensi karakteristik \emph{bearing}
...
yang paling umum pada \emph{rolling element bearings}.
...
berkorespondensi dengan konsep fisika klasik diagnosis getaran \emph{bearing},
...
(PHM2012: \emph{test set} delapan \emph{bearings}, tiga kondisi operasi;
XJTU-SY: \emph{test set} dua \emph{bearings}, dua kondisi operasi) menunjukkan
beberapa pola konsistensi yang bermakna.

Pertama, peringkat kinerja antar model berfluktuasi antar dataset karena
karakteristik distribusi data yang berbeda (rekaman per \emph{bearing}, variasi
...
didesain khusus untuk karakteristik sinyal degradasi \emph{rolling element bearings}.
...
fitur SAE ke frekuensi karakteristik fisik \emph{bearing} (BPFO, BPFI, BSF, FTF)
...
bahwa model \emph{deep learning} yang dilatih untuk prediksi RUL \emph{bearing}
mempelajari representasi laten yang berkorespondensi dengan frekuensi
karakteristik fisik \emph{bearing} (BPFI pada PHM2012, $r = 0{,}507$; BPFO pada
...
Bab~\ref{bab:hasil-pembahasan}, berikut ini enam arah pengembangan yang
...
Tabel~\ref{tab:bab5_hitrate} perlu divalidasi lebih lanjut dengan
...
karakteristik \emph{bearing} melalui supervisi fisik parsial.
