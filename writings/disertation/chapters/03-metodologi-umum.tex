...
dan prognostik} yang saling melengkapi, spesifikasi empat dataset publik,
prosedur praproses sinyal dan ekstraksi fitur, metrik evaluasi bersama untuk
\textcolor{blue}{keduanya}, serta infrastruktur komputasi dan protokol reproduksi.
Metodologi spesifik \textcolor{blue}{tiap pendekatan} dikembangkan lebih lanjut di awal Bab~IV
...
Penelitian ini disusun dalam \textcolor{blue}{dua pendekatan} paralel yang mencerminkan dua moda
...
(DT/RF/XGBoost), dan DeepExplainer untuk jaringan dalam (WDCNN).
...
\caption{Kerangka konseptual terintegrasi: \textcolor{blue}{pendekatan diagnostik} (biru) menggunakan dataset
...
Pemilihan \textcolor{blue}{dua pendekatan paralel} (bukan satu \textcolor{blue}{alur} hirarkis tunggal) mencerminkan
...
Empat dataset publik digunakan dalam penelitian ini: satu untuk \textcolor{blue}{diagnostik}
dan tiga untuk \textcolor{blue}{prognostik}. Semua merupakan dataset \emph{benchmark} yang banyak
diacu dalam literatur perawatan prediktif \emph{bearing}.
...
penting untuk validasi interpretabilitas \textcolor{blue}{prognostik}: apabila SAE memetakan
...
\textcolor{blue}{Pembagian data pada dataset IMS mengikuti protokol berbasis
\emph{bearing} (\emph{bearing-wise}): \emph{Bearing}~1 dan \emph{Bearing}~2
...
Pada \textcolor{blue}{diagnostik} (\emph{benchmark} kernel/pohon keputusan/jaringan dalam),
