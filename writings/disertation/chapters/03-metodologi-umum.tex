...
\begin{tabular}{@{}lllll@{}}
\toprule
\textbf{Dataset} & \textbf{Jalur} & \textbf{\emph{Bearing}/Kelas} & \textbf{Fs (kHz)} & \textbf{Tugas} \\
\midrule
CWRU    & A (Diagnostik)  & 1 \emph{rig}, 10 kelas & 48   & Klasifikasi kerusakan \\
PHM2012 & B (Prognostik)  & 17 \emph{bearing}            & 25,6 & Estimasi RUL \\
XJTU-SY & B (Prognostik)  & 10 \emph{bearing}            & 25,6 & Estimasi RUL \\
IMS     & B (Prognostik)  & 4 \emph{bearing} × 3 run     & 20   & Estimasi RUL \\
\bottomrule
\end{tabular}
\end{table}
...
frekuensi karakteristik \emph{bearing} (BPFx) pada Jalur~B.
