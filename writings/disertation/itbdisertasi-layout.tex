...
%     = 21\,pt pada 14\,pt). Setelah |\appendix|, judul lampiran memakai
%     bentuk |[hang]| (rata kiri; baris lanjutan menjorok selebar label
%     ``Lampiran X '') --- lihat |\itbSetupAppendixChapterHeadings| di
%     |itbdisertasi.cls|.
% ---------------------------------------------------------------------------
