...
yang memasuki model pada Bab~\ref{bab:metodologi}--\ref{bab:hasil-pembahasan}.
...
Bab~\ref{bab:hasil-pembahasan} mengikuti pola
...
(Persamaan~\ref{eq:bab4_band_energy} pada Bab~\ref{bab:metodologi})
...
\emph{bearings} set latih, diikuti pemulusan eksponensial sepanjang indeks
waktu dengan koefisien $\alpha_{\mathrm{smooth}} = 0{,}10$
(sebagaimana pada Bab~\ref{bab:metodologi}).
