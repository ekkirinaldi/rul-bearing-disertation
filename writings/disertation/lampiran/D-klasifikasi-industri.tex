...
\chapter{Validasi Industri PT~SKF Indonesia: \emph{Sanity Check} Eksternal}
...
(OR1 dan OR2) pada lini produksi bantalan bola di Cikarang. Sensor
...
Di sisi lini produksi, setiap produk bantalan yang selesai diproses
...
% -----------------------------------------------------------------
\section{Skema \emph{Sanity Check}: Inferensi dengan Model CWRU}
...
§\ref{sec:bab4_kernel}) diterapkan secara langsung untuk menginferensi
...
parameter geometri bantalan SKF~6205 sebagai aproksimasi frekuensi
...
dengan temuan Bab~\ref{bab:diagnostik} §\ref{subsec:bab4_shap_hasil_kernel}.
...
penelitian lanjutan ini selaras dengan §\ref{sec:bab6_rekomendasi}
Bab~VI.
