...
Bab~\ref{bab:diagnostik} §\ref{sec:bab4_wdcnn}--§\ref{sec:bab4_fsm}.
...
morfologi impuls transien yang karakteristik bagi kerusakan bantalan,
...
Bab~\ref{bab:diagnostik} §\ref{subsec:bab4_wdcnn_ablasi}, dilakukan
...
durasi tipikal transien impuls pada kerusakan bantalan (~40--50~ms
...
§\ref{subsec:bab4_wdcnn_ablasi} dan Bab~\ref{bab:kesimpulan}
§\ref{sec:bab6_pdm_multitier}.
