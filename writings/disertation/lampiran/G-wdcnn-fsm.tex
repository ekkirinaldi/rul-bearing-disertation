...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.92\textwidth]{figures/lampG/lampG_fsm_varA.png}
  \caption{FSM \emph{Absolute full-resolution} varian A (baseline
           dengan \emph{BatchNorm}) untuk kesepuluh kelas kerusakan
           CWRU. Resolusi 2.048 posisi per kelas; model mencapai
           akurasi 99,87\% pada set uji.}
  \label{fig:lampG_fsm_fullres}
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=0.92\textwidth]{figures/lampG/lampG_fsm_varC.png}
  \caption{FSM \emph{Absolute full-resolution} varian C (tanpa
           \emph{BatchNorm}). Puncak atribusi lebih tajam dan
           lebih terlokalisasi dibanding varian A; akurasi 92,0\%
           dengan \emph{tradeoff} interpretabilitas yang meningkat.}
