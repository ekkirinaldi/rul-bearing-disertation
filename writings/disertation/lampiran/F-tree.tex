...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.90\textwidth]{figures/lampF/lampF_cm_dt.png}
  \caption{Matriks konfusi Decision Tree pada set uji CWRU 10 kelas.
           Akurasi 94,0\%; pola \emph{off-diagonal}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.90\textwidth]{figures/lampF/lampF_cm_rf.png}
  \caption{Matriks konfusi Random Forest pada set uji CWRU 10 kelas.
           Akurasi 94,9\%; keunggulan \emph{bagging}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.90\textwidth]{figures/lampF/lampF_cm_xgb.png}
  \caption{Matriks konfusi XGBoost pada set uji CWRU 10 kelas.
           Akurasi 95,3\%; XGBoost menjadi pemenang
