...
(\texttt{configs/train/cloud\_full\_75.yaml}) untuk memastikan perbandingan
yang adil. Perbedaan hanya pada hyperparameter spesifik arsitektur yang
didokumentasikan pada subbab di atas.
...
\begin{table}[ht]
  ...
  \begin{tabular}{@{}lll@{}}
    ...
    Batch size (PHM2012) & 256 (Mamba + NBEATS, paralel) / 512 (SparseGate) & \\
    Batch size (XJTU-SY) & 256 (Mamba + NBEATS) / 512 (SparseGate) & \\
