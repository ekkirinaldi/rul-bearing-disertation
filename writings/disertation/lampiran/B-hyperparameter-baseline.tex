...
lengkap untuk seluruh model yang dievaluasi pada Bab~\ref{bab:prognostik},
...
berikut berlaku untuk konfigurasi eksperimen utama (Bab~\ref{bab:prognostik}).
...
pada Bab~\ref{bab:metodologi-umum} dan Bab~\ref{bab:prognostik}.
