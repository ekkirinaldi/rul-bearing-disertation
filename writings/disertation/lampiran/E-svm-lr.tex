...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.90\textwidth]{figures/lampE/lampE_cm_svm.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.90\textwidth]{figures/lampE/lampE_cm_lr.png}
  \caption{Matriks konfusi Logistic Regression pada set uji CWRU 10
           kelas. Akurasi 94,4\%; kebocoran LR lebih menyebar
